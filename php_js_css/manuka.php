...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($fullName === "") {
        ...
        $errors["fullName"] = "Emri vetëm me shkronja.";
    }
    ...
    if ($phone === "") {
        ...
        $errors["phone"] = "Numri nuk është valid.";
    }
    ...
    // GUESTS
    if ($guests === "") {
        $errors["guests"] = "Numri është i detyrueshëm.";
    ...
    if (empty($errors)) {
        try {
            ...
            VALUES (:restaurant_id, :full_name, :phone, :email, :date, :time, :guests, :message)");
            ...
            $success = "Rezervimi u ruajt me sukses!";

            $fullName = $phone = $email = $date = $time = $guests = $message = "";

        } catch (PDOException $e) {
            $errors["general"] = "Ndodhi një gabim gjatë ruajtjes.";
        }
    }
}
?>
